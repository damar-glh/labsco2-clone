...
const AceSection = () => {
  return (
    <section className="flex flex-col w-full min-h-screen bg-bg-primary xl:h-screen h-full gap-10 mt-20">
      <div className="text-center">
        <h1 className="text-5xl font-black text-black">ACE</h1>
        <p className="text-2xl font-generalsans-semibold mt-5">Methodology for Strategic Consulting</p>
      </div>
